...
$q = mysqli_query($koneksikan, "SELECT * FROM tb_user WHERE id='$id'");
$petugas = mysqli_fetch_array($q);

// Periksa apakah data ditemukan
if (!$petugas) {
    echo "<script>alert('Data tidak ditemukan!'); window.location='lihat_login.php';</script>";
    exit;
}
?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- End of Topbar -->
         ...
         <div class="container">
          <center><h4>Masukan Data Admin Dengan Benar</h4></center>
          <!-- Outer Row -->
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="p-5"> 
                    ...
                    <form class="user" action="edit_login.php" method="post">
    <div class="form-group">
        <input type="hidden" name="id_login" value="<?php echo $petugas['id']; ?>">
    </div>
    <div class="form-group">
        <input type="text" class="form-control" placeholder="Masukkan username..." name="username" required value="<?php echo $petugas['username']; ?>">
    </div>
    <div class="form-group">
        <input type="password" class="form-control" placeholder="Password" name="pass" required value="">
    </div>
    <input type="submit" class="btn bg-gradient-dark btn-block" value="Simpan">
    <input type="reset" class="btn bg-gradient-dark btn-block" value="Reset">
</form>
                        </select>
                     <hr>
                    </form>
                      <center><a href="lihat_login.php">Kembali Ke Pengolahan Data Admin</a></center>
                    <hr>
                  </div>
                </div>
              </div>
