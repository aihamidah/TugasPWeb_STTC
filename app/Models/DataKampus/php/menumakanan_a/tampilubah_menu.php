<?php
  ...
  $id_menumakanan = $_GET['id'];

  $q   = mysqli_query($koneksikan, "SELECT * FROM tb_menumakanan WHERE id_menumakanan='$id_menumakanan' ");
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- End of Topbar -->
         ...
         <div class="container">
          <center><h4>Masukan Data Petugas Dengan Benar</h4></center>
          <!-- Outer Row -->
          <div class="row justify-content-center">
            <div class="col-xl-5">
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="p-5"> 
                    <form class="user" action="edit_menu.php" method="post">
                      <div class="form-group">
                        <input type="text" class="form-control" placeholder="Masukan Nama Dosen" name="nama_makanan" required="required">
                      </div>   
                      <div class="form-group">
                        <input type="text" class="form-control" placeholder="Masukan NIDN" name="nama_makanan" required="required">
                      </div>   
                      <div class="form-group">
                        <input type="text" class="form-control" placeholder="Masukan Departemen" name="nama_makanan" required="required">
                      </div>   
                      <div class="form-group">
                        <input type="text" class="form-control" placeholder="Masukan Email" name="nama_makanan" required="required">
                      </div>   
                      ...
                      <center><a href="lihat_menu.php">Kembali Ke Pengolahan Data Menu Makanan</a></center>
                    <hr>
                  </div>
                </div>
              </div>
