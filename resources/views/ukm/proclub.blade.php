    ...
    <nav class="navbar navbar-expand-lg navbar-light navbarKu fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="../images/proclub.png" alt="STT Cipasung" />
          <h1>Programing Club<br/>STT Cipasung</h1>
        </a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="ukm/images/p1.jpg" class="d-block w-100" alt="Slide 1">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/p2.jpg" class="d-block w-100" alt="Slide 2">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/p3.jpg" class="d-block w-100" alt="Slide 3">
        </div>
        <div class="carousel-item">
            <img src="ukm/images/p4.jpg" class="d-block w-100" alt="Slide 3">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/p5.jpg" class="d-block w-100" alt="Slide 3">
        </div>
        <!-- <div class="carousel-item">
