    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="ukm/images/k3.jpeg" class="d-block w-100" alt="Slide 1">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/k2.jpeg" class="d-block w-100" alt="Slide 2">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/k4.png" class="d-block w-100" alt="Slide 3">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/k1.jpeg" class="d-block w-100" alt="Slide 3">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/k5.jpg" class="d-block w-100" alt="Slide 3">
        </div>
