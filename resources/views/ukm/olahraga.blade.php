    ...
    <nav class="navbar navbar-expand-lg navbar-light navbarKu fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="../images/olahraga.png" alt="STT Cipasung" />
          <h1>Olahraga<br/>STT Cipasung</h1>
        </a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="ukm/images/o2.png" class="d-block w-100" alt="Slide 1">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/o1.png" class="d-block w-100" alt="Slide 2">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/o5.png" class="d-block w-100" alt="Slide 3">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/o3.png" class="d-block w-100" alt="Slide 3">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/o4.png" class="d-block w-100" alt="Slide 3">
        </div>
