    ...
    <nav class="navbar navbar-expand-lg navbar-light navbarKu fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="../images/kerohanian.png" alt="STT Cipasung" />
          <h1>KEROHANIAN<br/>STT Cipasung</h1>
        </a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="ukm/images/a1.png" class="d-block w-100" alt="Slide 1">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/a2.jpg" class="d-block w-100" alt="Slide 2">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/a3.jpg" class="d-block w-100" alt="Slide 3">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/a4.png" class="d-block w-100" alt="Slide 3">
        </div>
        <div class="carousel-item">
          <img src="ukm/images/a5.png" class="d-block w-100" alt="Slide 3">
        </div>
