      ...
      <div class="row">
        <div class="col-md-12" style="padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9;">
          <p style="text-align: justify; color: #333; font-size: 16px; line-height: 1.6;">
                Jurusan Teknik Industri di Sekolah Tinggi Teknologi (STT) Cipasung hadir untuk mencetak
                lulusan yang mampu mengintegrasikan ilmu teknik, manajemen, dan teknologi dalam meningkatkan
                efisiensi dan produktivitas sistem industri. Dengan pendekatan multidisiplin, jurusan ini
                fokus pada analisis, perancangan, dan pengelolaan proses produksi, sistem logistik, serta
                pengoptimalan sumber daya.

                Kurikulum kami dirancang untuk mengasah kemampuan analitis, problem solving, dan inovasi
                melalui pembelajaran berbasis proyek, praktikum di laboratorium modern, dan studi kasus
                dunia industri nyata. Didukung oleh dosen profesional dan jejaring mitra industri, kami
                memberikan kesempatan kepada mahasiswa untuk mengembangkan kompetensi dalam manajemen
                kualitas, rekayasa sistem, ergonomi, dan teknologi manufaktur terkini.

                Bersama Teknik Industri STT Cipasung, jadilah pemimpin dalam menciptakan solusi
                berkelanjutan untuk tantangan industri masa depan!
