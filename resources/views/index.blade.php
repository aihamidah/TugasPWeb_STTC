...
<ul id="autoWidth" class="cs-hidden">
    ...
    <div class="sambutan">
        ...
        <p>
           STT Cipasung Menyediakan pendidikan tinggi yang inklusif dan berkualitas bagi setiap insan, <br>
           mencetak generasi unggul tanpa batasan, untuk masa depan yang lebih baik dan berdaya saing global<br>
           Ada 2 jurusan yang siap mempersiapkan anda menjadi orang sukses
        </p>
    </div>
    ...
    <div class="kepsek">
        <div class="container">
            <img src="images/pimpinan.JPG" alt="Pimpinan STT Cipasung">

            <div class="visiMisi">

                <div class="visi">
                    <h5>Our Vision</h5>
                    <h3>Menjadi Sekolah Tinggi lima besar di Priangan Timur pada tahun 2024 dan unggul di bidang entrepreneurship yang rahmatan lil'alamin.</h3>
                </div>

                <div class="misi">
                    <h5>Our Mission</h5>
                    <p>
                        Memperkuat kerjasama dengan institusi lain di tingkat wilayah maupun di tingkat nasional
                    </p>
                </div>
    ...
    <div class="jurusan">
        <div class="container">
            ...
            <div class="boxJurusan">
                ...
                <div class="perBox">
                    <a href="{{ url('/informatika') }}"><img src="images/prodi/if.jpeg" alt="informatika">
                    <h3>Informatika</h3></a>
                </div>

                <div class="perBox">
                    <a href="{{ url('/TeknikIndustri') }}"><img src="images/prodi/ti.jpeg" alt="industri">
            ...
            <div class="contact">
               ...
               <center><h2>Contact Us</h2></center>
                      <div class="section-title">
                        ...
                        <p>Supaya lebih mudah dalam berkomunikasi serta pemanfaatan jejaring sosial dan zaman modernnisasi maka ini adalah kontak terlampir.</p>
                      </div>
                      ...
                      <div class="row" data-aos="fade-up" data-aos-delay="100">
                        <div class="col-lg-6">
                          <div class="info-box mb-4">
                            <i class="bx bx-map"></i>
                            <h3>Our Address</h3>
                            <p>Sekolah Tinggi Teknologi Cipasung. Jl. Cisinga No.KM1, Cilampunghilir, Kec. Padakembang, Kabupaten Tasikmalaya, Jawa Barat 46466</p>
                          </div>
                        </div>
