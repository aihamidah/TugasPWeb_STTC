          ...
          <div class="row justify-content-center">
            <div class="col-xl-5">
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="p-5"> 
                    <form class="user" action="ptambah_pemesanan.php" method="post">
                        <div class="form-group">
                      
                    
                      <div class="form-group">
                        <input type="text" class="form-control" placeholder="Nama Fasilitas" name="nama_fasilitas" required="required">
                      </div>   
                      <div class="form-group">
                        <input type="text" class="form-control" id="exampleInputPassword" placeholder="Jenis Fasilitas" name="jenis_fasilitas" required="required">
                      </div>
                      ...
                      <center><a href="lihat_pemesanan.php">Kembali Ke Pengolahan Pemesanan</a></center>
                    <hr>
                  </div>
                </div>
              </div>
